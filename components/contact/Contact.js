        ...
        <section>
          <form method="post" action="#" className = {styles.formf}>
            <div className={styles.fields}>
              ...
              <div className={styles.field}>
                <label for="email" className = {styles.labell}>Email</label>
                <input type="text" name="email" id="email" />
              </div>
              <div className={styles.field}>
                <label for="message" className = {styles.labell}>Message</label>
                <textarea name="message" id="message" rows="3"></textarea>
              </div>
            </div>
            <ul className={styles.action}>
              <li>
                <input type="submit" value="Send Message" className = {styles.buttonsubmit}/>
              </li>
            </ul>
          </form>
        </section>
        <section className={styles.splitcontact}>
          ...
          <section>
            ...
            <ul className={styles.iconsalt}>
              ...
              <li>
                <a href="https://www.instagram.com/lohit_reddyk/" className={styles.icon}>
                  <span className={styles.label}>Instagram</span>
                </a>
              </li>
              <li>
                <a href="https://www.snapchat.com/add/lohitreddy359?share_id=59_YEeLu2BM&locale=en-US" className={styles.icon}>
